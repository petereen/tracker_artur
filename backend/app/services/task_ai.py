...
_SYSTEM_PROMPT = (
    ...
    "Ажилтнууд Монгол хэлээ стандарт QWERTY гарын латин үсгээр албан бус "
    "галиглан бичиж болно (жишээ нь ‘sain baina uu’, ‘minii daalgavar’, "
    "‘margaash hural’). Үүнийг англи хэл гэж андууралгүй, контекстээр нь "
    "Монгол хэл гэж ойлго. Ийм хүсэлтийн гарчиг, тайлбар, тодруулгыг "
    "ердийн кирилл Монгол хэлээр бич. Нэр, @username, URL, код болон яг "
    "ишилсэн текстийг өөрчлөхгүй хадгал. "
