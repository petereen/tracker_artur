...
const resources = {
  mn: { translation: {
    'nav.today': 'Өнөөдөр', 'nav.projects': 'Төслүүд', 'nav.tasks': 'Даалгавар', 'nav.reports': 'Тайлан',
  ...
  en: { translation: {
    'nav.today': 'Today', 'nav.projects': 'Projects', 'nav.tasks': 'Tasks', 'nav.reports': 'Reports',
  ...
  ru: { translation: {
    'nav.today': 'Сегодня', 'nav.projects': 'Проекты', 'nav.tasks': 'Задачи', 'nav.reports': 'Отчёты',
