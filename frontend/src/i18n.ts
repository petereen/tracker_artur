...
const resources = {
  mn: { translation: {
    ...
    'nav.capacity': 'Багийн ачаалал', 'nav.okrs': 'Зорилго', 'nav.plans': 'Төлөвлөгөө', 'nav.analytics': 'Үзүүлэлт', 'nav.settings': 'Тохиргоо',
  ...
  en: { translation: {
    ...
    'nav.capacity': 'Team capacity', 'nav.okrs': 'Goals', 'nav.plans': 'Plans', 'nav.analytics': 'Analytics', 'nav.settings': 'Settings',
  ...
  ru: { translation: {
    ...
    'nav.capacity': 'Загрузка команды', 'nav.okrs': 'Цели', 'nav.plans': 'Планы', 'nav.analytics': 'Аналитика', 'nav.settings': 'Настройки',
