...
const OPERATOR = '«Даалгавар хянагч» үйлчилгээний оператор'
...
export function TermsPage() {
  return (
    <LegalShell title="Үйлчилгээний нөхцөл">
      <p>Telegram бот болон <b>{DOMAIN}</b> дээрх вэб апп-аар ашиглах «Даалгавар хянагч» үйлчилгээг (цаашид «Үйлчилгээ» гэх) ашигласнаар та энэхүү нөхцөлийг зөвшөөрнө.</p>
