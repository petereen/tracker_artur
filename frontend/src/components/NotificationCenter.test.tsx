...
vi.mock('../api/enterprise', () => ({
  ...
  useToggleNotificationPriority: () => ({ mutate: togglePriority, isPending: false }),
}))

describe('NotificationCenter', () => {
  beforeEach(() => { readOne.mockClear(); readAll.mockClear(); togglePriority.mockClear() })
  ...
  it('shows unread state and exposes read actions in the dropdown', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Чухал гэж тэмдэглэх' }))
    expect(togglePriority).toHaveBeenCalledWith({ id: 7, is_priority: true })
  })
})
