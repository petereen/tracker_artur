...
export interface PayrollAdditionalSalary { id: number; number: string; employee_id: number; salary_component_id: number; salary_component_code?: string | null; payroll_date: string; amount: string; component_kind: 'earning' | 'deduction'; taxable: boolean; shi_subject: boolean; source: string; reference: string | null; status: 'draft' | 'submitted' | 'cancelled' | 'consumed'; payroll_run_id: number | null; submitted_at?: string | null }
