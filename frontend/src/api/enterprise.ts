...
export interface ContractArchiveEntry { id: number; public_id: string; folder_id: number | null; source: ArchiveSource; contract_id: number | null; name: string; category: string; content_type: string; size: number; checksum: string; scan_status: string; review_status: ArchiveReviewStatus; review_reason: string | null; expiry_on: string | null; expiry_reminder_days: number[]; signing_status: string; author: ArchivePerson | null; uploader: ArchivePerson | null; reviewer: ArchivePerson | null; contract_title: string | null; created_at: string; updated_at: string; reviewed_at: string | null; can_view: boolean; can_download: boolean; can_edit: boolean; can_delete: boolean; can_manage_access: boolean }
