...
export interface PayrollEntry extends PayrollRun { workflow_version: 'frappe_v1'; document_status: 'draft' | 'submitted' | 'cancelled'; employee_ids?: number[]; variable_inputs?: PayrollVariableInput[]; attendance_validation?: boolean }
