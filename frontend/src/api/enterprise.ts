...
export interface PayrollRun { id: number; run_number: string; run_type: 'advance' | 'final' | 'single' | 'off_cycle' | 'reversal'; period_start: string; period_end: string; settlement_key: string; tax_point_date: string; status: string; reversal_of_run_id?: number | null; replacement_of_run_id?: number | null; statutory_profile_id: number; posting_profile_id?: number | null; erp_document_id?: number | null; total_gross: string; total_employee_shi: string; total_employer_shi: string; total_pit: string; total_net: string; snapshot_checksum: string; reconciliation?: PayrollReconciliation; approval_workflow?: { stages?: PayrollApprovalStage[]; locked?: boolean }; approved_at?: string | null; posted_at?: string | null; payslips_published_at?: string | null }
export interface PayrollPayslip { id: number; payroll_run_id: number; employee_id: number; gross: string; taxable_income: string; shi_subject_gross: string; shi_base: string; employee_shi: string; employer_shi: string; pit: string; pit_relief: string; advance_offset: string; net_pay: string; snapshot_checksum: string; ytd?: Record<string, string>; trace?: Record<string, unknown>; lines?: Array<{ code: string; label: string; kind: string; amount: string; taxable: boolean; shi_subject: boolean; payer: string; formula: string }> }
