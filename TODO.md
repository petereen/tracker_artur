...
## Current Milestone
- [x] Fix chat voice upload MIME/filename handling, add live recording visualization, and build Telegram-style waveform playback (`frontend/src/pages/ChatWorkspacePage.tsx`, `frontend/src/index.css`)
